...
def feature_engineering(df):
    """
    Fügt neue Features durch Feature Engineering hinzu.
    """
    # Rollende Mittelwerte und Standardabweichungen
    ...
    # Zeitbasiertes Feature
    df['Day_of_Week'] = df.index.dayofweek  # Montag=0, Sonntag=6
